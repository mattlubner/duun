...
Duun (pronounced like the film [_Dune_](http://en.wikipedia.org/wiki/Dune_(film))) is an extensible sandbox written in Javascript / CommonJS for decoupling web application components.
